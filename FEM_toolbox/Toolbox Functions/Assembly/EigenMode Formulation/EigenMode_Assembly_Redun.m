function [TModel] = EigenMode_Assembly(TModel),AssembledSystem=TModel.Assembled;Frequency=TModel.Frequency;bian_flag=BianCheck(TModel);
    if(Frequency.NF==1)
        ...
        switch AssembledSystem.PropagationAxis
            case "x"
                for id=1:numel(TModel.Domains),Domain=TModel.Domains(id);medium=Domain.Medium;
                   switch medium.Type
                       case "Iso" ,[IA,JA,TEE,TBB,AA,FF,TS,TG,TBC,IB,JB,AW,FW,counterA,counterB] = EigenMode_Iso_Assembly_x(IA,JA,TEE,TBB,AA,FF,TS,TG,TBC,IB,JB,AW,FW,counterA,counterB,TModel,AssembledSystem,Domain);
                       case "Anis",[IA,JA,TEE,TBB,AA,FF,TS,TG,TBC,IB,JB,AW,FW,counterA,counterB] = EigenMode_Anis_Assembly_x(IA,JA,TEE,TBB,AA,FF,TS,TG,TBC,IB,JB,AW,FW,counterA,counterB,TModel,AssembledSystem,Domain);
                       case "Bian",[IA,JA,TEE,TBB,AA,FF,TS,TG,TBC,P,TA,TC,IB,JB,AW,FW,K,counterA,counterB] = EigenMode_Bian_Assembly_x(IA,JA,TEE,TBB,AA,FF,TS,TG,TBC,P,TA,TC,IB,JB,AW,FW,K,counterA,counterB,TModel,AssembledSystem,Domain);
                   end,disp("Domain " + num2str(Domain.Index) +"out of " +num2str(numel(TModel.Domains)) + " done");
                end
            case "y"
                for id=1:numel(TModel.Domains),Domain=TModel.Domains(id);medium=Domain.Medium;
                   switch medium.Type
                       case "Iso" ,[IA,JA,TEE,TBB,AA,FF,TS,TG,TBC,IB,JB,AW,FW,counterA,counterB] = EigenMode_Iso_Assembly_y(IA,JA,TEE,TBB,AA,FF,TS,TG,TBC,IB,JB,AW,FW,counterA,counterB,TModel,AssembledSystem,Domain);
                       case "Anis",[IA,JA,TEE,TBB,AA,FF,TS,TG,TBC,IB,JB,AW,FW,counterA,counterB] = EigenMode_Anis_Assembly_y(IA,JA,TEE,TBB,AA,FF,TS,TG,TBC,IB,JB,AW,FW,counterA,counterB,TModel,AssembledSystem,Domain);
                       case "Bian",[IA,JA,TEE,TBB,AA,FF,TS,TG,TBC,P,TA,TC,IB,JB,AW,FW,K,counterA,counterB] = EigenMode_Bian_Assembly_y(IA,JA,TEE,TBB,AA,FF,TS,TG,TBC,P,TA,TC,IB,JB,AW,FW,K,counterA,counterB,TModel,AssembledSystem,Domain);
                    end
                end
            case "z"
                for id=1:numel(TModel.Domains),Domain=TModel.Domains(id);medium=Domain.Medium;
                   switch medium.Type
                       case "Iso" ,[IA,JA,TEE,TBB,AA,FF,TS,TG,TBC,IB,JB,AW,FW,counterA,counterB] = EigenMode_Iso_Assembly_z(IA,JA,TEE,TBB,AA,FF,TS,TG,TBC,IB,JB,AW,FW,counterA,counterB,TModel,AssembledSystem,Domain);
                       case "Anis",[IA,JA,TEE,TBB,AA,FF,TS,TG,TBC,IB,JB,AW,FW,counterA,counterB] = EigenMode_Anis_Assembly_z(IA,JA,TEE,TBB,AA,FF,TS,TG,TBC,IB,JB,AW,FW,counterA,counterB,TModel,AssembledSystem,Domain);
                       case "Bian",[IA,JA,TEE,TBB,AA,FF,TS,TG,TBC,P,TA,TC,IB,JB,AW,FW,K,counterA,counterB] = EigenMode_Bian_Assembly_z(IA,JA,TEE,TBB,AA,FF,TS,TG,P,TA,TC,TBC,IB,JB,AW,FW,K,counterA,counterB,TModel,AssembledSystem,Domain);
                    end
                end
        end
        ...
        if(bian_flag),P=P(1:NonZeros);TA=TA(1:NonZeros);TC=TC(1:NonZeros);K=K(1:NonZerosB);P=sparse(IA,JA,P);TA=sparse(IA,JA,TA);TC=sparse(IA,JA,TC);K=sparse(IB,JB,K);
             TModel.Assembled=TModel.Assembled.EigenMode(TE,TB,A,F,TS,TG,TBC,FW,AW,P,TA,TC,K,freq);
        else,TModel.Assembled=TModel.Assembled.EigenMode(TE,TB,A,F,TS,TG,TBC,FW,AW,freq);
        end
    else
        for ii=1:Frequench.NF
                if(bian_flag),I=zeros(400*TModel.NumberOfElements,1);IA=I;JA=I;TEE=I;TBB=I;AA=I;FF=I;TS=I;TG=I;TBC=I;P=I;TC=I;TA=I;counterA=0;
                      I=zeros(400*TModel.NumberOfElements,1);IB=I;JB=I;AW=I;FW=I;K=I;counterB=0;
                else,I=zeros(400*TModel.NumberOfElements,1);IA=I;JA=I;TEE=I;TBB=I;AA=I;FF=I;TS=I;TG=I;TBC=I;counterA=0;
                      I=zeros(400*TModel.NumberOfElements,1);IB=I;JB=I;AW=I;FW=I;counterB=0;
              ...
              switch AssembledSystem.PropagationAxis
                case "x"
                    for id=1:numel(TModel.Domains),Domain=TModel.Domains(id);medium=Domain.Medium;
                        switch medium.Type
                            case "Iso" ,[IA,JA,TEE,TBB,AA,FF,TS,TG,TBC,IB,JB,AW,FW,counterA,counterB] = EigenMode_Iso_Assembly_x(IA,JA,TEE,TBB,AA,FF,TS,TG,TBC,IB,JB,AW,FW,counterA,counterB,TModel,AssembledSystem,Domain,ii);
                            case "Anis",[IA,JA,TEE,TBB,AA,FF,TS,TG,TBC,IB,JB,AW,FW,counterA,counterB] = EigenMode_Anis_Assembly_x(IA,JA,TEE,TBB,AA,FF,TS,TG,TBC,IB,JB,AW,FW,counterA,counterB,TModel,AssembledSystem,Domain,ii);
                            case "Bian",[IA,JA,TEE,TBB,AA,FF,TS,TG,TBC,P,TA,TC,IB,JB,AW,FW,K,counterA,counterB] = EigenMode_Bian_Assembly_x(IA,JA,TEE,TBB,AA,FF,TS,TG,TBC,P,TA,TC,IB,JB,AW,FW,K,counterA,counterB,TModel,AssembledSystem,Domain,ii);
                        end
                    end
                case "y"
                    for id=1:numel(TModel.Domains),Domain=TModel.Domains(id);medium=Domain.Medium;
                        switch medium.Type
                            case "Iso" ,[IA,JA,TEE,TBB,AA,FF,TS,TG,TBC,IB,JB,AW,FW,counterA,counterB] = EigenMode_Iso_Assembly_y(IA,JA,TEE,TBB,AA,FF,TS,TG,TBC,IB,JB,AW,FW,counterA,counterB,TModel,AssembledSystem,Domain,ii);
                            case "Anis",[IA,JA,TEE,TBB,AA,FF,TS,TG,TBC,IB,JB,AW,FW,counterA,counterB] = EigenMode_Anis_Assembly_y(IA,JA,TEE,TBB,AA,FF,TS,TG,TBC,IB,JB,AW,FW,counterA,counterB,TModel,AssembledSystem,Domain,ii);
                            case "Bian",[IA,JA,TEE,TBB,AA,FF,TS,TG,TBC,P,TA,TC,IB,JB,AW,FW,K,counterA,counterB] = EigenMode_Bian_Assembly_y(IA,JA,TEE,TBB,AA,FF,TS,TG,TBC,P,TA,TC,IB,JB,AW,FW,K,counterA,counterB,TModel,AssembledSystem,Domain,ii);
                        end 
                    end
                case "z"
                    for id=1:numel(TModel.Domains),Domain=TModel.Domains(id);medium=Domain.Medium;
                        switch medium.Type
                            case "Iso" ,[IA,JA,TEE,TBB,AA,FF,TS,TG,TBC,IB,JB,AW,FW,counterA,counterB] = EigenMode_Iso_Assembly_z(IA,JA,TEE,TBB,AA,FF,TS,TG,IB,JB,AW,FW,counterA,counterB,TModel,AssembledSystem,Domain,ii);
                            case "Anis",[IA,JA,TEE,TBB,AA,FF,TS,TG,TBC,IB,JB,AW,FW,counterA,counterB] = EigenMode_Anis_Assembly_z(IA,JA,TEE,TBB,AA,FF,TS,TG,IB,JB,AW,FW,counterA,counterB,TModel,AssembledSystem,Domain,ii);
                            case "Bian",[IA,JA,TEE,TBB,AA,FF,TS,TG,TBC,P,TA,TC,IB,JB,AW,FW,K,counterA,counterB] = EigenMode_Bian_Assembly_z(IA,JA,TEE,TBB,AA,FF,TS,TG,P,TA,TC,IB,JB,AW,FW,K,counterA,counterB,TModel,AssembledSystem,Domain,ii);
                         end
                    end
               end
               NonZeros=nnz(IA);IA=IA(1:NonZeros);JA=JA(1:NonZeros);TEE=TEE(1:NonZeros);TBB=TBB(1:NonZeros);AA=AA(1:NonZeros);FF=FF(1:NonZeros);TS=TS(1:NonZeros);TG=TG(1:NonZeros);TBC=TBC(1:NonZeros);
               ...
               if(bian_flag),P=P(1:NonZeros);TA=TA(1:NonZeros);TC=TC(1:NonZeros);K=K(1:NonZerosB);P=sparse(IA,JA,P);TA=sparse(IA,JA,TA);TC=sparse(IA,JA,TC);K=sparse(IB,JB,K);
                     TModel.Assembled=TModel.Assembled.EigenMode(TE,TB,A,F,TS,TG,TBC,FW,AW,P,TA,TC,K,Frequency.Frequency(ii),ii);
               else,TModel.Assembled=TModel.Assembled.EigenMode(TE,TB,A,F,TS,TG,TBC,FW,AW,Frequency.Frequency(ii),ii);
               end
        end
    end
...
%===================== x Axis Propagation =================================
function [IA,JA,TEE,TBB,AA,FF,TS,TG,TBC,IB,JB,AW,FW,counterA,counterB] = EigenMode_Iso_Assembly_x(varargin),GaussianQuadratture3D;
    if(nargin==18),IA=varargin{1};JA=varargin{2};TEE=varargin{3};TBB=varargin{4};AA=varargin{5};FF=varargin{6};
                   TS=varargin{7};TG=varargin{8};TBC=varargin{9};IB=varargin{10};JB=varargin{11};AW=varargin{12};FW=varargin{13};
                   counterA=varargin{14};counterB=varargin{15};TModel=varargin{16};AssembledSystem=varargin{17};
                   Domain=varargin{18};medium=Domain.Medium;epsilon=medium.Epsilon;mu=medium.Mu;imu=mu^-1;
    elseif(nargin==19),IA=varargin{1};JA=varargin{2};TEE=varargin{3};TBB=varargin{4};AA=varargin{5};FF=varargin{6};
                       TS=varargin{7};TG=varargin{8};TBC=varargin{9};IB=varargin{10};JB=varargin{11};AW=varargin{12};FW=varargin{13};
                       counterA=varargin{14};counterB=varargin{15};TModel=varargin{16};AssembledSystem=varargin{17};
                       Domain=varargin{18};FreqIndex=varargin{19};medium=Domain.Medium;
    ...
    for ie=1:numel(Domain.Elements),element=TModel.Elements(Domain.Elements(ie));disp("element " + num2str(ie) +" out of " + num2str(numel(Domain.Elements)));
        ...
        for kt=1:numel(Weights),zeta(1)=Points(1,kt);zeta(2)=Points(2,kt);zeta(3)=Points(3,kt);zeta(4)=Points(4,kt);
                 ...
                 wfx(3)=2*zeta(1)*(c(3)*d(4)-c(4)*d(3))+2*zeta(2)*(c(4)*d(1)-c(1)*d(4))+2*zeta(4)*(c(1)*d(3)-c(3)*d(1));  wfy(3)=2*zeta(1)*(d(3)*b(4)-d(4)*b(3))+2*zeta(2)*(d(4)*b(1)-d(1)*b(4))+2*zeta(4)*(d(1)*b(3)-d(3)*b(1));wfz(3)=2*zeta(1)*(b(3)*c(4)-b(4)*c(3))+2*zeta(2)*(b(4)*c(1)-b(1)*c(4))+2*zeta(4)*(b(1)*c(3)-b(3)*c(1));
                 ...
                 xwfx(1)=0;xwfy(1)=-wfz(1);xwfz(1)=wfy(1);xwfx(2)=0;xwfy(2)=-wfz(2);xwfz(2)=wfy(2);
                 xwfx(3)=0;xwfy(3)=-wfz(3);xwfz(3)=wfy(3);xwfx(4)=0;xwfy(4)=-wfz(4);xwfz(4)=wfy(4);
                 %==================== Local Matrices =====================
        ...
        for ii=1:4,di=abs(facets(ii).UknownIndex);dsi=sign(facets(ii).UknownIndex);si=facetSigns(ii);
            for jj=1:6,dj=abs(edges(jj).UknownIndex);dsj=sign(edges(jj).UknownIndex);sj=edgeSigns(jj);
                if(di~=0 && dj~=0),counterA=counterA+1;IA(counterA)=di;JA(counterA)=dj;FF(counterA)=si*dsi*sj*dsj*Fm(ii,jj);
                                   counterB=counterB+1;IB(counterB)=di;JB(counterB)=dj;FW(counterB)=si*sj*di*dj*Fw(ii,jj);
                end
            end
        end
        for ii=1:4,di=abs(facets(ii).UknownIndex);dsi=sign(facets(ii).UknownIndex);si=facetSigns(ii);
...
function [IA,JA,TEE,TBB,AA,FF,TS,TG,TBC,IB,JB,AW,FW,counterA,counterB] = EigenMode_Anis_Assembly_x(varargin),GaussianQuadratture3D;
    if(nargin==18),IA=varargin{1};JA=varargin{2};TEE=varargin{3};TBB=varargin{4};AA=varargin{5};FF=varargin{6};
                   TS=varargin{7};TG=varargin{8};TBC=varargin{9};IB=varargin{10};JB=varargin{11};AW=varargin{12};FW=varargin{13};
                   counterA=varargin{14};counterB=varargin{15};TModel=varargin{16};AssembledSystem=varargin{17};
                   Domain=varargin{18};medium=Domain.Medium;epsilon=medium.Epsilon;mu=medium.Mu;imu=mu^-1;
...
function [IA,JA,TEE,TBB,AA,FF,TS,TG,TBC,P,TA,TC,IB,JB,AW,FW,K,counterA,counterB] = EigenMode_Bian_Assembly_x(varargin),GaussianQuadratture3D;
    if(nargin==22),IA=varargin{1};JA=varargin{2};TEE=varargin{3};TBB=varargin{4};AA=varargin{5};FF=varargin{6};
                   TS=varargin{7};TG=varargin{8};TBC=varargin{9};P=varargin{10};TA=varargin{11};TC=varargin{12};IB=varargin{13};
                   JB=varargin{14};AW=varargin{15};FW=varargin{16};K=varargin{17};counterA=varargin{18};
                   counterB=varargin{19};TModel=varargin{20};AssembledSystem=varargin{21};
                   Domain=varargin{22};medium=Domain.Medium;epsilon=medium.Epsilon;mu=medium.Mu;imu=mu^-1;ksi=medium.Ksi;zita=medium.Zita;
    elseif(nargin==23),IA=varargin{1};JA=varargin{2};TEE=varargin{3};TBB=varargin{4};AA=varargin{5};FF=varargin{6};
                       TS=varargin{7};TG=varargin{8};TBC=varargin{9};P=varargin{10};TA=varargin{11};TC=varargin{12};IB=varargin{13};
                       JB=varargin{14};AW=varargin{15};FW=varargin{16};K=varargin{17};counterA=varargin{18};
                       counterB=varargin{19};TModel=varargin{20};AssembledSystem=varargin{21};
                       Domain=varargin{22};FreqIndex=varargin{22};medium=Domain.Medium;
        ...
        for kt=1:numel(Weights),zeta(1)=Points(1,kt);zeta(2)=Points(2,kt);zeta(3)=Points(3,kt);zeta(4)=Points(4,kt);
             %---------------------- Edge Basis Functions -------------
               ...
               %-------------- x cross Edge Basis Functions -------------
                ...
                xmwx(1)=0;xmwy(1)=-mzwz(1);xmwz(1)=mzwy(1);xmwx(2)=0;xmwy(2)=-mzwz(2);xmwz(2)=mzwy(2);xmwx(3)=0;xmwy(3)=-mzwz(3);xmwz(3)=mzwy(3);
                xmwx(4)=0;xmwy(4)=-mzwz(4);xmwz(4)=mzwy(4);xmwx(5)=0;xmwy(5)=-mzwz(5);xmwz(5)=mzwy(5);xmwx(6)=0;xmwy(6)=-mzwz(6);xmwz(6)=mzwy(6);
                %----------------------------------------------------------
                for ii=1:6
                     for jj=1:6,Te(ii,jj)=Te(ii,jj)+Weights(kt)*(wx(ii)*epsilon(1,1)*wx(jj) +wx(ii)*epsilon(1,2)*wy(jj) +wx(ii)*epsilon(1,3)*wz(jj)...
                                                                  +wy(ii)*epsilon(2,1)*wx(jj)+wy(ii)*epsilon(2,2)*wy(jj)+wy(ii)*epsilon(2,3)*wz(jj)...
...
%===================== y Axis Propagation =================================
function [IA,JA,TEE,TBB,AA,FF,TS,TG,TBC,IB,JB,AW,FW,counterA,counterB] = EigenMode_Iso_Assembly_y(varargin),GaussianQuadratture3D;
    if(nargin==18),IA=varargin{1};JA=varargin{2};TEE=varargin{3};TBB=varargin{4};AA=varargin{5};FF=varargin{6};
                   TS=varargin{7};TG=varargin{8};TBC=varargin{9};IB=varargin{10};JB=varargin{11};AW=varargin{12};FW=varargin{13};
                   counterA=varargin{14};counterB=varargin{15};TModel=varargin{16};AssembledSystem=varargin{17};
                   Domain=varargin{18};medium=Domain.Medium;epsilon=medium.Epsilon;mu=medium.Mu;imu=mu^-1;
    ...
    for ie=1:numel(Domain.Elements),element=TModel.Elements(Domain.Elements(ie));
        ...
        for kt=1:numel(Weights),zeta(1)=Points(1,kt);zeta(2)=Points(2,kt);zeta(3)=Points(3,kt);zeta(4)=Points(4,kt);
                 ...
                 ywx(1)=wz(1);ywy(1)=0;ywz(1)=-wx(1);ywx(2)=wz(2);ywy(2)=0;ywz(2)=-wx(2);ywx(3)=wz(3);ywy(3)=0;ywz(3)=-wx(3);
                 ywx(4)=wz(1);ywy(4)=0;ywz(4)=-wx(4);ywx(5)=wz(2);ywy(5)=0;ywz(5)=-wx(5);ywx(6)=wz(6);ywy(6)=0;ywz(6)=-wx(6);
                 %-------------- y cross Facet Basis Functions -------------
                 ywfx(1)=wfz(1);ywfy(1)=0;ywfz(1)=-wfx(1);ywfx(2)=wfz(2);ywfy(2)=0;ywfz(2)=-wfx(2);
                 ywfx(3)=wfz(3);ywfy(3)=0;ywfz(3)=-wfx(3);ywfx(4)=wfz(1);ywfy(4)=0;ywfz(4)=-wfx(4);
                 %==================== Local Matrices =====================
                 for ii=1:6,for jj=1:6,Te(ii,jj)=Te(ii,jj)+Weights(kt)*epsilon*(wx(ii)*wx(jj)+wy(ii)*wy(jj)+wz(ii)*wz(jj));end,end
                 for ii=1:4,for jj=1:4,Tb(ii,jj)=Tb(ii,jj)+Weights(kt)*(wfx(ii)*wfx(jj)+wfy(ii)*wfy(jj)+wfz(ii)*wfz(jj));end,end
                 for ii=1:4
...
function [IA,JA,TEE,TBB,AA,FF,TS,TG,TBC,IB,JB,AW,FW,counterA,counterB] = EigenMode_Anis_Assembly_y(varargin),GaussianQuadratture3D;
    if(nargin==18),IA=varargin{1};JA=varargin{2};TEE=varargin{3};TBB=varargin{4};AA=varargin{5};FF=varargin{6};
                   TS=varargin{7};TG=varargin{8};TBC=varargin{9};IB=varargin{10};JB=varargin{11};AW=varargin{12};FW=varargin{13};
                   counterA=varargin{14};counterB=varargin{15};TModel=varargin{16};AssembledSystem=varargin{17};
                   Domain=varargin{18};medium=Domain.Medium;epsilon=medium.Epsilon;mu=medium.Mu;imu=mu^-1;
    ...
    for ie=1:numel(Domain.Elements),element=TModel.Elements(Domain.Elements(ie));
        ...
        for kt=1:numel(Weights),zeta(1)=Points(1,kt);zeta(2)=Points(2,kt);zeta(3)=Points(3,kt);zeta(4)=Points(4,kt);
             %---------------------- Edge Basis Functions -------------
                 ...
                 ywfx(1)=mwfz(1);ywfy(1)=0;ywfz(1)=-mwfx(1);ywfx(2)=mwfz(2);ywfy(2)=0;ywfz(2)=-mwfx(2);
                 ywfx(3)=mwfz(3);ywfy(3)=0;ywfz(3)=-mwfx(3);ywfx(4)=mwfz(4);ywfy(4)=0;ywfz(4)=-mwfx(4);
                  %==================== Local Matrices =====================
                 for ii=1:6
                     for jj=1:6,Te(ii,jj)=Te(ii,jj)+Weights(kt)*(wx(ii)*epsilon(1,1)*wx(jj) +wx(ii)*epsilon(1,2)*wy(jj) +wx(ii)*epsilon(1,3)*wz(jj)...
                                                                  +wy(ii)*epsilon(2,1)*wx(jj)+wy(ii)*epsilon(2,2)*wy(jj)+wy(ii)*epsilon(2,3)*wz(jj)...
...
function [IA,JA,TEE,TBB,AA,FF,TS,TG,TBC,P,TA,TC,IB,JB,AW,FW,K,counterA,counterB] = EigenMode_Bian_Assembly_y(varargin),GaussianQuadratture3D;
    if(nargin==22),IA=varargin{1};JA=varargin{2};TEE=varargin{3};TBB=varargin{4};AA=varargin{5};FF=varargin{6};
                   TS=varargin{7};TG=varargin{8};TBC=varargin{9};P=varargin{10};TA=varargin{11};TC=varargin{12};IB=varargin{13};
                   JB=varargin{14};AW=varargin{15};FW=varargin{16};K=varargin{17};counterA=varargin{18};
                   counterB=varargin{19};TModel=varargin{20};AssembledSystem=varargin{21};
    ...
    for ie=1:numel(Domain.Elements),element=TModel.Elements(Domain.Elements(ie));
        ...
        for kt=1:numel(Weights),zeta(1)=Points(1,kt);zeta(2)=Points(2,kt);zeta(3)=Points(3,kt);zeta(4)=Points(4,kt);
             %---------------------- Edge Basis Functions -------------
                ...
                ymwx(1)=mzwz(1);ymwy(1)=0;ymwz(1)=-mzwx(1);ymwx(2)=mzwy(2);ymwy(2)=0;ymwz(2)=-mzwx(2);ymwx(3)=mzwy(3);ymwy(3)=0;ymwz(3)=-mzwx(3);
                ymwx(4)=mzwz(1);ymwy(4)=0;ymwz(4)=-mzwx(4);ymwx(5)=mzwy(2);ymwy(5)=0;ymwz(5)=-mzwx(5);ymwx(6)=mzwy(6);ymwy(6)=0;ymwz(6)=-mzwx(6);
                %----------------------------------------------------------
                for ii=1:6
                     for jj=1:6,Te(ii,jj)=Te(ii,jj)+Weights(kt)*(wx(ii)*epsilon(1,1)*wx(jj) +wx(ii)*epsilon(1,2)*wy(jj) +wx(ii)*epsilon(1,3)*wz(jj)...
                                                                  +wy(ii)*epsilon(2,1)*wx(jj)+wy(ii)*epsilon(2,2)*wy(jj)+wy(ii)*epsilon(2,3)*wz(jj)...
...
%===================== z Axis Propagation =================================
function [IA,JA,TEE,TBB,AA,FF,TS,TG,TBC,IB,JB,AW,FW,counterA,counterB] = EigenMode_Iso_Assembly_z(varargin),GaussianQuadratture3D;
    if(nargin==18),IA=varargin{1};JA=varargin{2};TEE=varargin{3};TBB=varargin{4};AA=varargin{5};FF=varargin{6};
                   TS=varargin{7};TG=varargin{8};TBC=varargin{9};IB=varargin{10};JB=varargin{11};AW=varargin{12};FW=varargin{13};
                   counterA=varargin{14};counterB=varargin{15};TModel=varargin{16};AssembledSystem=varargin{17};
                   Domain=varargin{18};medium=Domain.Medium;epsilon=medium.Epsilon;mu=medium.Mu;imu=mu^-1;
    ...
    for ie=1:numel(Domain.Elements),element=TModel.Elements(Domain.Elements(ie));
        ...
        for kt=1:numel(Weights),zeta(1)=Points(1,kt);zeta(2)=Points(2,kt);zeta(3)=Points(3,kt);zeta(4)=Points(4,kt);
                 ...
                 zwx(1)=wy(1);zwy(1)=-wx(1);zwz(1)=0;zwx(2)=wy(2);zwy(2)=-wx(2);zwz(2)=0;zwx(3)=wy(3);zwy(3)=-wx(3);zwz(3)=0;
                 zwx(4)=wy(1);zwy(4)=-wx(4);zwz(4)=0;zwx(5)=wy(2);zwy(5)=-wx(5);zwz(5)=0;zwx(6)=wy(6);zwy(6)=-wx(6);zwz(6)=0;
                 %-------------- z cross Facet Basis Functions -------------
                 zwfx(1)=wfy(1);zwfy(1)=-wfx(1);zwfz(1)=0;zwfx(2)=wfy(2);zwfy(2)=-wfx(2);zwfz(2)=0;
                 zwfx(3)=wfy(3);zwfy(3)=-wfx(3);zwfz(3)=0;zwfx(4)=wfy(1);zwfy(4)=-wfx(4);zwfz(4)=0;
                 %==================== Local Matrices =====================
                 for ii=1:6,for jj=1:6,Te(ii,jj)=Te(ii,jj)+Weights(kt)*epsilon*(wx(ii)*wx(jj)+wy(ii)*wy(jj)+wz(ii)*wz(jj));end,end
                 for ii=1:4,for jj=1:4,Tb(ii,jj)=Tb(ii,jj)+Weights(kt)*(wfx(ii)*wfx(jj)+wfy(ii)*wfy(jj)+wfz(ii)*wfz(jj));end,end
                 for ii=1:4
...
function [IA,JA,TEE,TBB,AA,FF,TS,TG,TBC,IB,JB,AW,FW,counterA,counterB] = EigenMode_Anis_Assembly_z(varargin),GaussianQuadratture3D;
    if(nargin==18),IA=varargin{1};JA=varargin{2};TEE=varargin{3};TBB=varargin{4};AA=varargin{5};FF=varargin{6};
                   TS=varargin{7};TG=varargin{8};TBC=varargin{9};IB=varargin{10};JB=varargin{11};AW=varargin{12};FW=varargin{13};
                   counterA=varargin{14};counterB=varargin{15};TModel=varargin{16};AssembledSystem=varargin{17};
                   Domain=varargin{18};medium=Domain.Medium;epsilon=medium.Epsilon;mu=medium.Mu;imu=mu^-1;
    ...
    for ie=1:numel(Domain.Elements),element=TModel.Elements(Domain.Elements(ie));
        ...
        for kt=1:numel(Weights),zeta(1)=Points(1,kt);zeta(2)=Points(2,kt);zeta(3)=Points(3,kt);zeta(4)=Points(4,kt);
             %---------------------- Edge Basis Functions -------------
                 ...
                 zwx(4)=wy(1);zwy(4)=-wx(4);zwz(4)=0;zwx(5)=wy(2);zwy(5)=-wx(5);zwz(5)=0;zwx(6)=wy(6);zwy(6)=-wx(6);zwz(6)=0;
                 %-------------- y cross mr^-1 Facet Basis Functions ------
                 zwfx(1)=mwfy(1);zwfy(1)=-mwfx(1);zwfz(1)=0;zwfx(2)=mwfy(2);zwfy(2)=-mwfx(2);zwfz(2)=0;
                 zwfx(3)=mwfy(3);zwfy(3)=-mwfx(3);zwfz(3)=0;zwfx(4)=mwfy(1);zwfy(4)=-mwfx(4);zwfz(4)=0;
                  %==================== Local Matrices =====================
                 for ii=1:6
                     for jj=1:6,Te(ii,jj)=Te(ii,jj)+Weights(kt)*(wx(ii)*epsilon(1,1)*wx(jj) +wx(ii)*epsilon(1,2)*wy(jj) +wx(ii)*epsilon(1,3)*wz(jj)...
                                                                  +wy(ii)*epsilon(2,1)*wx(jj)+wy(ii)*epsilon(2,2)*wy(jj)+wy(ii)*epsilon(2,3)*wz(jj)...
...
function [IA,JA,TEE,TBB,AA,FF,TS,TG,TBC,P,TA,TC,IB,JB,AW,FW,K,counterA,counterB] = EigenMode_Bian_Assembly_z(varargin),GaussianQuadratture3D;
    if(nargin==22),IA=varargin{1};JA=varargin{2};TEE=varargin{3};TBB=varargin{4};AA=varargin{5};FF=varargin{6};
                   TS=varargin{7};TG=varargin{8};TBC=varargin{9};P=varargin{10};TA=varargin{11};TC=varargin{12};IB=varargin{13};
                   JB=varargin{14};AW=varargin{15};FW=varargin{16};K=varargin{17};counterA=varargin{18};
                   counterB=varargin{19};TModel=varargin{20};AssembledSystem=varargin{21};
    ...
    for ie=1:numel(Domain.Elements),element=TModel.Elements(Domain.Elements(ie));
        ...
        for kt=1:numel(Weights),zeta(1)=Points(1,kt);zeta(2)=Points(2,kt);zeta(3)=Points(3,kt);zeta(4)=Points(4,kt);
             %---------------------- Edge Basis Functions -------------
                ...
                zmwx(1)=mzwy(1);zmwy(1)=-mzwx(1);zmwz(1)=0;zmwx(2)=mzwy(2);zmwy(2)=-mzwx(2);zmwz(2)=0;zmwx(3)=mzwy(3);zmwy(3)=-mzwx(3);zmwz(3)=0;
                zmwx(4)=mzwy(1);zmwy(4)=-mzwx(4);zmwz(4)=0;zmwx(5)=mzwy(2);zmwy(5)=-mzwx(5);zmwz(5)=0;zmwx(6)=mzwy(6);zmwy(6)=-mzwx(6);zmwz(6)=0;
...
function [n] = findNormaVector(TModel,element,facetIndex),v1=TModel.Vertices(element.Vertices(1));v2=TModel.Vertices(element.Vertices(2));v3=TModel.Vertices(element.Vertices(3));v4=TModel.Vertices(element.Vertices(4));
    ...
    end,n=cross(vec1,vec2);if(n'*vec3>0),n=-n;end
end
