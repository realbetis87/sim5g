...
%}
%--------------------------------------------------------------------------
function [Ex,Ey,Ez,Bx,By,Bz,xx,yy,zz] = PlotSlice_EB_Red(varargin)
...
function [Ex,Ey,Ez,Bx,By,Bz,xx,yy,zz]=PlotZPlane(tmodel,EdgeVector,FacetVector,xx,yy,zz,N1,N2),error=1000*eps;empty=zeros(N1,N2);Ex=empty;Ey=empty;Ez=empty;Bx=empty;By=empty;Bz=empty;
    ...
    [cmap]=buildcmap('cbkry');figure;
    subplot(1,3,1);pcolor(real(Ex));shading interp;hold on;colormap(cmap);title('x Component Electric Field Real Part');colorbar;axis tight;axis equal;
    subplot(1,3,2);pcolor(real(Ey));shading interp;hold on;colormap(cmap);title('y Component Electric Field Real Part');colorbar;axis tight;axis equal;
    subplot(1,3,3);pcolor(real(Ez));shading interp;colormap(cmap);title('z Component Electric Field Real Part');colorbar;axis tight;axis equal;
    figure;
    subplot(1,3,1);pcolor(real(Bx));shading interp;hold on;colormap(cmap);title('x Component Magnetic Flux Real Part');colorbar;axis tight;axis equal;
    subplot(1,3,2);pcolor(real(By));shading interp;hold on;colormap(cmap);title('y Component Magnetic Flux Real Part');colorbar;axis tight;axis equal;
    subplot(1,3,3);pcolor(real(Bz));shading interp;colormap(cmap);title('z Component Magnetic Flux Real Part');colorbar;axis tight;axis equal;
    figure;
    subplot(2,3,1);pcolor(imag(Ex));shading interp;hold on;colormap(cmap);title('x Component Electric Field Imaginary Part');colorbar;axis tight;axis equal;
    subplot(2,3,2);pcolor(imag(Ey));shading interp;hold on;colormap(cmap);title('y Component Electric Field Imaginary Part');colorbar;axis tight;axis equal;
    subplot(2,3,3);pcolor(imag(Ez));shading interp;colormap(cmap);title('z Component Electric Field Imaginary Part');colorbar;axis tight;axis equal;
